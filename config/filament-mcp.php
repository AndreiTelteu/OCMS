...
use App\Mcp\PrepareArticleData;
use App\Mcp\PrepareCategoryData;
use App\Mcp\PreparePageData;
use App\Mcp\PrepareTagData;
...
return [
    ...
    */
    ...
    'panel' => env('FILAMENT_MCP_PANEL', 'admin'),
    ...
    */
    ...
    'resources' => [
        ArticleResource::class => [
            ...
            'update' => true,
            'delete' => false,
            'prepare' => PrepareArticleData::class,
        ],
        CategoryResource::class => [
            ...
            'update' => true,
            'delete' => false,
            'prepare' => PrepareCategoryData::class,
        ],
        PageResource::class => [
            'read' => true,
            'create' => true,
